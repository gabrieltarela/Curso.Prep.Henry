...
function diaDeLaSemana(numeroDeDia) {
    ...
    //1 = Domingo, 2 = Lunes y así sucesivamente. 
...
function mesesDelAño(array) {
    ...
    // "Enero", "Marzo" y "Noviembre", guardarlo en nuevo array y 
    //retornarlo.
    ...
    //Gabriel T: Si se repite algun mes esta verificacion no va a funcionar
    // Ej: ["Enero","Enero","Enero","Enero"] no entrara en el if a pesar
    // de que no estan todos los meses pedidos
    if (aResu.length < 3) {
    ...
    var aResu = [];
    var aMeses = ["Enero","Marzo","Noviembre"];
    
    for (let i = 0; i< aMeses.length;i++){
        
        let indice = array.indexOf(aMeses[i]);    
        
        if (indice === -1){
          return "No se encontraron los meses pedidos";  
        } 
        aResu.push(array[indice]);
...
function breakStatement(numero) {
    ...
    //de iteraciones coinciden, debe interrumpirse la ejecución y 
