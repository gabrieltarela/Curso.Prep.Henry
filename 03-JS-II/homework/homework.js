...
function conection(status) {
    //Recibimos un estado de conexión de un usuario representado 
...
function saludo(idioma) {
    ...
    // Si "idioma" no es ninguno de los anteiores o es `undefined` 
    //devuelve "Hola!"
    // Tu código:
...
function operadoresLogicos(num1, num2, num3) {
    ...
    //Si alguno de los tres números es negativo, retornar ---> 
    //"Hay negativos"
...
function tablaDelSeis() {
    //Escribe una función que muestre la tabla de multiplicar del 6 
    //(del 0 al 60).
    //La función devuelve un array con los resultados de la tabla 
